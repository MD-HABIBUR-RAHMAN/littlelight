...
const double _kTrackWidth = 30.0;
...
const double _kSwitchHeightCollapsed = kRadialReactionRadius;
...
class SmallerSwitch extends StatefulWidget {
  ...
  ///
  /// Ignored if this switch is created with [SmallerSwitch.adaptive].
  ...
  @override
  _SmallerSwitchState createState() => _SmallerSwitchState();
...
class _SmallerSwitchState extends State<SmallerSwitch>
...
class _RenderSwitch extends RenderToggleable {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    const double trackHorizontalPadding = 0;
